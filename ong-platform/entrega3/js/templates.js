// Templates em JS (retornam strings HTML)
...
export function renderHome() {
  return `
    ...
    <section class="section" aria-labelledby="banner-title">
      <h2 id="banner-title" class="sr-only">Imagem de destaque</h2>
      <picture>
    ...
    <section class="section" aria-labelledby="conquistas">
      <h2 id="conquistas">Histórico e Conquistas</h2>
      <div class="grid grid-12">
        <article class="card span-12 md-span-6">
          <div class="card-body">
            <div class="card-title">Projeto Escola Verde</div>
            <div class="card-meta"><span class="badge green">Meio Ambiente</span></div>
            <p>Educação ambiental para escolas e comunidades desde 2018.</p>
          </div>
        </article>
        <article class="card span-12 md-span-6">
          <div class="card-body">
            <div class="card-title">Capacitação Jovem</div>
            <div class="card-meta"><span class="badge blue">Educação</span></div>
            <p>Mais de 300 jovens capacitados em tecnologia e cidadania.</p>
          </div>
        </article>
      </div>
    </section>
...
export function renderProjetos({ searchParams }) {
  ...
  return `
    ...
    <section aria-labelledby="banner-proj">
      <h2 id="banner-proj" class="sr-only">Banner</h2>
      <picture>
        <source srcset="images/volunteer.webp" type="image/webp">
        <source srcset="images/volunteer.jpg" type="image/jpeg">
        <img src="images/volunteer.jpg" alt="Voluntários sorrindo em área verde" loading="lazy" width="1200" height="500">
      </picture>
    </section>
  ...
  return `
    <section class="section" aria-labelledby="dest">
      ...
      <div class="cards">
        ...
        ${card('Alfabetiza+','images/header-project.jpg','Educação','Refôrço escolar e alfabetização.')}
  ...
  return `
    ...
    <form id="cadastroForm" class="form" action="#" method="post" novalidate>
      <fieldset>
        ...
        <small id="cpfHelp" class="help">Formato: 000.000.000-00</small>
